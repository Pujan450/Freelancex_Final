...
//                 <img
//                   className="pp"
//                   src={dataUser?.img || "/img/noavtar.jpg"}
//                   alt=""
//                 />
...
//                 <div className="user">
//                   <img src={dataUser?.img || "/img/noavtar.jpg"} alt="" />
//                   <div className="info">
//                     <span>{dataUser?.username}</span>
//                     {data.starNumber > 0 && (
//                       <div className="stars">
...
function Gig() {
  ...
  const {
    ...
    queryFn: () =>
      newRequest.get(`/users/${userId._id}/public`).then((res) => res.data),
    enabled: !!userId,
  });
